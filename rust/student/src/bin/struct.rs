fn main() {
    ...
    #[derive(Debug)]
    struct Namespace(String, String);
    let samantha = Namespace("Samantha".to_string(), String::from("Smith"));
    println!("Namespace is borrowed and stdout: {samantha:#?}.");
    dbg!("Namespace is owned and stderr: {}.", &samantha);
}
